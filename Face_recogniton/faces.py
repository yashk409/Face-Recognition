...
# Load images learn how to recognize it.
yash_image = face_recognition.load_image_file("yash.jpeg")
yash_face_encoding = face_recognition.face_encodings(yash_image)[0]

rohit_image = face_recognition.load_image_file("rohit.jpeg")
rohit_face_encoding = face_recognition.face_encodings(rohit_image)[0]

doctor_image = face_recognition.load_image_file("doctor.jpeg")
doctor_face_encoding = face_recognition.face_encodings(doctor_image)[0]

cruise_image = face_recognition.load_image_file("cruise.jpg")
...
kalu_image = face_recognition.load_image_file("kalu.jpeg")
kalu_face_encoding = face_recognition.face_encodings(kalu_image)[0]
